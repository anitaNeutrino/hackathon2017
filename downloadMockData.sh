...
curl $url/SimulatedAnitaHeadFile.root > data/run$run/SimulatedAnitaEventFile$run.root
curl $url/SimulatedAnitaTruthFile.root > data/run$run/SimulatedAnitaEventFile$run.root
curl $url/SimulatedAnitaGpsFile.root > data/run$run/SimulatedAnitaEventFile$run.root
